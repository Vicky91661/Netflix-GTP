...
function MovieTitle({title,description}) {
  return (
    <div className=' absolute text-white w-[70vw]  md:w-[60vw] top-[12vh] left-[5vw] md:top-[14vh] lg:top-[20vh] xl:top-[40vh] xl:w-[30vw] xl:left-[5vw] md:left-[5vw]  flex flex-col gap-2 md:gap-5 z-20'>
        <h1 className=' text-base font-medium md:font-bold md:text-3xl xl:text-5xl'>{title}</h1>
